...
Target.prototype = {
    _evalRawData: function(data) {
        ...
        var legendValue = function(stat) {
            self.callStack.unshift('legendValue');
        };

        var lineWidth = function(stat) {
            self.callStack.unshift('lineWidth');
        };

        var movingAverage = function(stat) {
            self.callStack.unshift('movingAverage');
        };
        ...
        var timeShift = function(stat) {
            self.callStack.unshift('timeShift');
        };
